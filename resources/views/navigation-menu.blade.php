<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::User()->hasRole('administrator'))
                        ...
                        <x-jet-nav-link :href="route('students.index')" :active="request()->is('students') || request()->is('students/*')">
                            {{ __('Students') }}
                        </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endif
            @if (Auth::User()->hasRole('teacher'))
                <x-jet-responsive-nav-link  :href="route('teacher.classrooms')" :active="request()->is('classrooms') || request()->is('classrooms/*')">
                    {{ __('My Classrooms') }}
                </x-jet-responsive-nav-link>
            ...
            @endif
            @if (Auth::User()->hasRole('administrator'))
                <x-jet-responsive-nav-link :href="route('teachers.index')" :active="request()->is('teachers') || request()->is('teachers/*')">
                    {{ __('Teachers') }}
                </x-jet-responsive-nav-link>
                <x-jet-responsive-nav-link :href="route('students.index')" :active="request()->is('students') || request()->is('students/*')">
                    {{ __('Students') }}
                </x-jet-responsive-nav-link>
